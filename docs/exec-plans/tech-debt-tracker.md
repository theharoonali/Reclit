...
| No toast system | `Toaster` and its ~15 transitive deps removed from `@repo/ui`; re-add via shadcn when a feature needs it. | 2026-08-19 |
...
| UI kit is one component | `@repo/ui` ships only `Button`; card/dialog/input/label/skeleton/table/textarea were removed. Re-add via shadcn as features need them. | 2026-08-21 |
